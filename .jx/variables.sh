...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-cli-base-image/master/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-cli-base-image:0.1.0'
